...
<div style="margin:20px 0;">
	<a href="javascript:void(0)" class="easyui-linkbutton" onclick="$('#w14').window('open')">统计数据(咨询)</a>
</div>
<div id="w14" class="easyui-window" title="统计数据(咨询)" style="width:670px;height:300px;padding:5px;" data-options="modal:true,closed:true">
	<table id="countDataCounselor" class="easyui-datagrid" title="统计数据(咨询)"
		style="width: 640px; height: 250px"
		data-options="
			iconCls: 'icon-edit',
			singleSelect: true,
			toolbar: '#cdc',
			url: '${pageContext.request.contextPath}/workspace/countDataCounselor?accountName='+username,
			method: 'post'">
		<thead>
			<tr>
