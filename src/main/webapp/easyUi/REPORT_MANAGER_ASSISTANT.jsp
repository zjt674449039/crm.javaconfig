...
<body>
	<h2>报表管理(助理)</h2>
	<form action="${pageContext.request.contextPath}/workspace/reportManagerAssistant/importCustomerInfo" enctype="multipart/form-data" method="post">
		<input type="file" accept="application/vnd.ms-excel" 
			name="tableData" id="tableData" class="easyui-linkbutton">
		<input type="submit" value="客户表信息导入" class="easyui-linkbutton">
	</form>
	<form action="#" method="post">
		<input type="button" value="客户表信息导出" id="exportExcelData" class="easyui-linkbutton">
	</form>
<script>
$("#exportExcelData").click(function(){
	$.ajax({
		url:"${pageContext.request.contextPath}/workspace/reportManagerAssistant/exportCustomerInfo",
		dataType:"json",
		success:function(data){
			alert('导出成功');
			JSONToExcelConvertor(data.datas, "customer", data.title);
		},
